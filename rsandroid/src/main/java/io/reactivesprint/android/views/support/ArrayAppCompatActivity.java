 ...
 */
public abstract class ArrayAppCompatActivity<VM extends IAndroidViewModel, AVM extends IArrayViewModel & IAndroidViewModel> extends RsAppCompatActivity<VM> implements IArrayView<VM, AVM> {
    @Override
