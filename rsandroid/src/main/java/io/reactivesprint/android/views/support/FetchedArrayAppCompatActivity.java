 ...
 */
public abstract class FetchedArrayAppCompatActivity<E extends IAndroidViewModel, VM extends IFetchedArrayViewModel<E, ?, ?, ?> & IAndroidViewModel>
        extends ArrayAppCompatActivity<E, VM>
